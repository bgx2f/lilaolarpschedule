      ...
      <div className="bg-white w-full max-w-sm rounded-3xl shadow-2xl border border-gray-200 overflow-hidden relative">
        ...
        <div className="p-8 flex flex-col items-center">
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-4">
                ...
                {successMsg && (
                     <div className="flex items-start gap-2 bg-green-50 text-green-600 p-3 rounded-lg text-sm font-bold animate-in slide-in-from-top-1 break-all">
