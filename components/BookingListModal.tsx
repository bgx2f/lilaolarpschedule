...
import { X, Search, Edit2, Trash2, Calendar, MapPin, Clock, User, Download, Check } from 'lucide-react';
...
const BookingListModal: React.FC<BookingListModalProps> = ({
  ...
  // Track which booking is currently being deleted (inline confirmation)
