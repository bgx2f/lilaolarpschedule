...
import { X, Plus, Trash2, MapPin, BookOpen, Settings, AlertTriangle, Check, Crown, Users, Shield, UserCheck, RefreshCw, Loader2, CalendarRange, StickyNote, ShieldCheck, Cloud } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 bg-white">
          {activeTab === 'members' && !isEditor && (
             <div className="space-y-4">
                 ...
                 {/* Fixed mobile overflow-x scrolling */}
          ...
          {activeTab === 'cloud' && !isEditor && (
            <div className="max-w-xl mx-auto py-10 flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-gray-900">Supabase 雲端同步中心</h3>
