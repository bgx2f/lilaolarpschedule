...
import { X, Plus, Trash2, MapPin, BookOpen, Settings, AlertTriangle, Check, Crown, Users, Shield, Save, Eye, EyeOff, UserCheck, UserX, Clock } from 'lucide-react';
...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<Tab>('members'); // Default to members for visibility
  ...
  const handleChangePassword = (e: React.FormEvent) => {
    ...
    // Verify old password (locally for now, ideally API)
    if (oldPassword !== currentUser.password) {
        setPasswordError('舊密碼不正確');
        return;
    }
                                 ...
                                 <tr key={member.id} className="hover:bg-gray-50">
                                     ...
                                     <td className="p-3">
                                         {member.role === MemberRole.ADMIN ? (
                                             ...
                                             <span className="text-gray-600">一般主持人</span>
                                         )}
                                     </td>
          ...
          {activeTab === 'npcs' && (
             ...
             <div className="flex gap-3">
              <input 
                ...
                className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500"
              />
              <button 
                type="button"
          ...
          {activeTab === 'security' && (
            <div className="flex flex-col h-full justify-center max-w-sm mx-auto w-full">
                <div className="text-center mb-6">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">修改您的密碼</h3>
