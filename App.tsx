...
const App: React.FC = () => {
  ...
  useEffect(() => localStorage.setItem('larp_deposit_labels', JSON.stringify(depositLabels)), [depositLabels]);
  ...
  return (
    <div className={`min-h-screen ${backgroundClass} text-gray-900 flex flex-col font-sans transition-colors duration-500`}>
      ...
      {/* Main Content - Improved scrolling/zooming layout */}
      <main className="flex-1 overflow-auto p-4 relative">
        ...
        {!currentUser ? (
            ...
            <>
                ...
                {viewMode === 'public' && (
                    <div className="h-full w-full max-w-7xl mx-auto animate-in fade-in duration-300 overflow-auto">
                        <PublicCalendar 
      ...
      {currentUser && (
          <SettingsModal 
            ...
            setDepositLabels={setDepositLabels}
            members={members}
