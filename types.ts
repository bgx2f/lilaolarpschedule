...
export interface Booking {
  ...
  depositLabel?: string; // New: Text label for "No deposit" cases
...
export interface Member {
  ...
  notes?: string; // New: Administrator notes about this member
}
...
export interface LarpData {
  ...
  holidays: string[];
  members: Member[];
  depositLabels: string[]; // New: Customizable no-deposit labels
  monthTags: string[]; // New: Customizable quick access month tags
  lastUpdated: string;
}
